...
ASSET = {
        ...
        ("kiri", "霧宮", "霧宮,麗斗", 17,(1,1), "male", "高校生", 'me:ボク:natsu:比嘉:yuji:倉敷'),
        ('natsu', '夏美', '比嘉,夏美', 17,(1,1), 'female', '高校生', 'me:わたし:霧宮君'),
        ('yuji', '優二', '倉敷,優二', 17,(1,1), 'male', '高校生', 'me:俺:natsu:比嘉:k_natsu:夏美:kiri:霧宮'),
        ...
        ('ClubRoom', '文芸部部室', 'HighSchool', (100,100)),
        ),
        "DAYS": (
